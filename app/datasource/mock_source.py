...
İşlem süresini (60-120 sn) simüle eder ve ilerleme yüzdesini periyodik
olarak bildirir; gerçek algoritma da benzer bir süre alacağı için arayüz
bu davranışa göre tasarlanmıştır.
"""
...
class MockDataSource(DataSource):
    ...
    async def tara(
        ...
        toplam_sure_sn = random.uniform(60, 120)
        adim_sn = 1.0
